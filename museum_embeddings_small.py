# The original plan was to generate embeddings for all museum records using CLIP.
# But due to the lack of free credits, I decided to just use the ngma_blr.json & nat_del.json.
# This script will run on Modal, a serverless platform for running Python code.

# All the data scraped from the museums (https://www.museumsofindia.gov.in/) is stored in json
# If you want to run this code, you need to have the data files in the same directory as this script.
...
app = modal.App("museum-embeddings-small",)
